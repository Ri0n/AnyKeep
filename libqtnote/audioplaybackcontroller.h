#ifndef QTNOTE_AUDIOPLAYBACKCONTROLLER_H
#define QTNOTE_AUDIOPLAYBACKCONTROLLER_H
...
class QTNOTE_EXPORT AudioPlaybackController final : public QObject {
    Q_OBJECT
...
#endif // QTNOTE_AUDIOPLAYBACKCONTROLLER_H
