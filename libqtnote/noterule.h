...
struct QTNOTE_EXPORT NoteRuleCondition {
    NoteRuleConditionKind kind { NoteRuleConditionKind::TitleMatches };
    QString               value;
    bool                  negated { false };
};

struct QTNOTE_EXPORT NoteRuleAction {
 ...
 */
struct QTNOTE_EXPORT NoteRuleApplicationMarker {
    QUuid      ruleId;
...
struct QTNOTE_EXPORT NoteRuleSnapshot {
    QList<NoteRule>                  rules;
    QList<NoteRuleApplicationMarker> markers;
};

struct QTNOTE_EXPORT NoteRuleError {
...
struct QTNOTE_EXPORT NoteRuleEvaluationInput {
    QString     storageId;
    QString     noteId;
    QString     title;
    QStringList tags;
 ...
 */
struct QTNOTE_EXPORT NoteRuleEvaluation {
...
class QTNOTE_EXPORT NoteRuleEvaluator final {
public:
