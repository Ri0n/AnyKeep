...
# QXmpp 1.15 discovers libomemo-c exclusively through pkg-config, which is
# commonly unavailable in native MSVC environments. Allow the enclosing
# bundled build to provide the already staged static libraries directly.
...
set(_openssl_new [=[find_package(OpenSSL QUIET CONFIG)
...
set(_pkgconfig_end [=[endif()

include(GNUInstallDirs)]=])
set(_omemo_fallback [=[endif()
