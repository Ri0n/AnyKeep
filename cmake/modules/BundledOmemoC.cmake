...
set(_protobuf_c_cmake_args
    "-DPROTOBUF_C_SOURCE_DIR=<SOURCE_DIR>"
...
ExternalProject_Add(anykeep_bundled_protobuf_c
    ...
    CONFIGURE_COMMAND
        "${CMAKE_COMMAND}"
        -S "${CMAKE_CURRENT_LIST_DIR}/../thirdparty/protobuf-c-runtime"
        -B <BINARY_DIR>
...
# libomemo-c 0.5.1 still declares cmake_minimum_required(VERSION 2.8.4).
# CMake 4 removed policy compatibility below 3.5. This variable is the
# supported external override for unmodified third-party projects.
