if(DEFINED ANYKEEP_ALLOW_SOURCE_DEPENDENCY_FALLBACKS AND NOT ANYKEEP_ALLOW_SOURCE_DEPENDENCY_FALLBACKS)
  message(FATAL_ERROR "BundledQCoro.cmake was included while ANYKEEP_ALLOW_SOURCE_DEPENDENCY_FALLBACKS=OFF")
endif()
...
set(ANYKEEP_BUNDLED_QCORO_VERSION
    "0.13.0"
    CACHE STRING "Bundled QCoro version")
set(ANYKEEP_QCORO_SOURCE_DIR
    ""
...
function(anykeep_add_bundled_qcoro)
  ...
  if(ANYKEEP_QCORO_SOURCE_DIR)
    if(NOT EXISTS "${ANYKEEP_QCORO_SOURCE_DIR}/CMakeLists.txt")
      message(FATAL_ERROR "ANYKEEP_QCORO_SOURCE_DIR does not contain a QCoro source tree: "
                          "${ANYKEEP_QCORO_SOURCE_DIR}")
    endif()
    FetchContent_Declare(
      anykeep_bundled_qcoro
      SOURCE_DIR
      "${ANYKEEP_QCORO_SOURCE_DIR}")
  else()
    FetchContent_Declare(
      ...
      GIT_TAG "v${ANYKEEP_BUNDLED_QCORO_VERSION}"
      GIT_SHALLOW TRUE
      GIT_PROGRESS TRUE)
  endif()
...
# QCoro 0.13 exports QCoro::Core when used through FetchContent. Keep a defensive alias for source snapshots that expose
# only the concrete target.
