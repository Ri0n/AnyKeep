...
struct ANYKEEP_EXPORT FolderRecord {
    QUuid     id;
    QUuid     parentId;
    QString   name;
    qint64    sortOrder { 0 };
...
struct ANYKEEP_EXPORT NoteFolderAssignment {
    QString storageId;
    QString noteId;
    QUuid   folderId;
 ...
 */
struct ANYKEEP_EXPORT ProviderPathHint {
    QString     storageId;
    QStringList path;
    QUuid       folderId;
    quint64     revision { 0 };
...
struct ANYKEEP_EXPORT ProviderFolderPathAssignment {
    QString     noteId;
    QStringList path;
    QDateTime   modifiedAt;
};

struct ANYKEEP_EXPORT FolderCatalogSnapshot {
 ...
 * Undo operation.
 */
struct ANYKEEP_EXPORT DeletedFolderBranch {
    QUuid                       rootId;
    QList<FolderRecord>         folders;
    QList<NoteFolderAssignment> assignments;
    QList<ProviderPathHint>     pathHints;
...
struct ANYKEEP_EXPORT FolderCatalogError {
    enum Code {
        None,
        InvalidArgument,
        NotFound,
...
/**
 * Validated in-memory representation of AnyKeep's global folder catalog.
 *
 ...
 */
class ANYKEEP_EXPORT FolderCatalog {
public:
