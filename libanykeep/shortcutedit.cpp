...
ShortcutEdit::ShortcutEdit(Main *anykeep, const QString &option, QWidget *parent) :
    QLineEdit(parent), anykeep(anykeep), option(option)
{
}
...
{
    anykeep->shortcutsManager()->setShortcutEnable(option, false);
