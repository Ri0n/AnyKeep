#ifndef ANYKEEP_SETTINGSCONTROLLER_H
#define ANYKEEP_SETTINGSCONTROLLER_H
...
class ANYKEEP_EXPORT SettingsController : public QAbstractListModel {
    Q_OBJECT
...
class ANYKEEP_EXPORT PersistentSettingsController final : public SettingsController {
    Q_OBJECT
...
#endif // ANYKEEP_SETTINGSCONTROLLER_H
