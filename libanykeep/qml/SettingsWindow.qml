...
ApplicationWindow {
    ...
    property var settingsController: anykeepSettingsController
    property url settingsContentSource: anykeepSettingsComponent
    property string settingsTitle: anykeepSettingsTitle
